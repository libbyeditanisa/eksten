          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <form action="<?php echo site_url("KaryawanController/add") ?>" method="post"> 
                  ...
                  <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="nama" class="form-control form-control-user" placeholder="Masukkan nama karyawan .." required>
                  </div>
                  <div class="form-group">
                    <label>Email</label>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="notelp" class="form-control form-control-user" placeholder="Masukkan no telepon .." required>
                  </div>
                  <div class="form-group">
                    <label>Alamat</label>
